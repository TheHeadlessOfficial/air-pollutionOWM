...
next3a = "${alignc}${color}${execpi 900 sed -n '33p' $HOME" + conkypath + "apchoisen.txt |cut -c1-18} ${color2}${alignc}AQI: ${color}${execpi 900 sed -n '23p' $HOME" + conkypath + "apchoisen.txt}"
...
next4a = "${alignc}${color}${execpi 900 sed -n '44p' $HOME" + conkypath + "apchoisen.txt |cut -c1-18} ${color2}${alignc}AQI: ${color}${execpi 900 sed -n '34p' $HOME" + conkypath + airfolder + "apchoisen.txt}"
...
next5a = "${alignc}${color}${execpi 900 sed -n '55p' $HOME" + conkypath + "apchoisen.txt |cut -c1-18} ${color2}${alignc}AQI: ${color}${execpi 900 sed -n '45p' $HOME" + conkypath + airfolder + "apchoisen.txt}"
